...
const data = {
  ...
  namaPembeli: "CHEN SEE NGA",
  alamatPengirim: [
    "#25-06, Menara C,",
    "Pangsapuri Seri Permata,",
    "Jalan Kunyit, Taman Sri Amar,",
    "81100 Johor Bahru, Johor.",
  ],
  noKP: "880808-35-5292",
  telefonPembeli: "+65 8273 47373",
  emailPembeli: "xiahsn@gmail.com",
  ...
  alamatHartanah: "Parcel C-25-06, Menara C, Pangsapuri Seri Permata, Jalan Kunyit, Taman Sri Amar, 81100 Johor Bahru, Johor",
  jenisHartanah: "Pangsapuri (Apartment/Flat)",
  namaProyek: "Pangsapuri Seri Permata",

  noSPA: "",
  tarikhSPA: "10 Disember 2022",
  jenisSPA: "Jadual H",
  klausaPembaikan: "26(1)",
  klausaSerahan: "28(1)",
  tempohDLP: "24",

  tarikhPemeriksaan1: "20 Disember 2025",
  tarikhPemeriksaan2: "24 Jun 2026",
  tarikhSerahanLaporan: "24 Disember 2025",
  kaedahSerahanLaporan: "Aplikasi Marvis (digital submission)",
  tarikhSerahanLaporan2: "2 Julai 2026",
  ...
  kecacatan: [
    { tag: "1", lokasi: "Kitchen (Ceiling)", kecacatan: "Medium moisture on ceiling still observed", status: "Pembaikan Tidak Sempurna" },
    { tag: "11", lokasi: "Living & Dining (M&E)", kecacatan: "Exposed copper on DB box", status: "Belum Dibaiki" },
    { tag: "12", lokasi: "Living & Dining (M&E)", kecacatan: "Need to review SPD cable size", status: "Belum Dibaiki" },
    { tag: "13", lokasi: "Living & Dining (M&E)", kecacatan: "Missing 10mm2 earth cable connected to earthing system", status: "Belum Dibaiki" },
    { tag: "26", lokasi: "Yard (Floor)", kecacatan: "Stagnant water on floor tiles", status: "Belum Dibaiki" },
    { tag: "30", lokasi: "Yard (Ceiling)", kecacatan: "Uneven surface on ceiling", status: "Belum Dibaiki" },
    { tag: "67", lokasi: "Bathroom 2", kecacatan: "Construction leftover inside floor trap (cement)", status: "Belum Dibaiki" },
    { tag: "83", lokasi: "Balcony (Master Bedroom)", kecacatan: "Light point for Live+Earth and Live+Neutral has low voltage (142V)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "10 Disember 2022", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual H" },
    { tarikh: "20 Disember 2025", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "24 Disember 2025", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui Aplikasi Marvis (digital submission)" },
    { tarikh: "23 Januari 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — tiada tindakan pembaikan yang memuaskan / tidak sempurna" },
    { tarikh: "24 Jun 2026", peristiwa: "Pemeriksaan Kecacatan Kali Kedua (Second Inspection) dijalankan — kecacatan masih wujud" },
    { tarikh: "2 Julai 2026", peristiwa: "Laporan Pemeriksaan Kali Kedua diserahkan kepada pemaju melalui Aplikasi Marvis" },
...
const fn = `*Senarai kecacatan di atas merujuk kepada penemuan terkini dalam Laporan Pemeriksaan Kecacatan Kali Kedua pada ${data.tarikhPemeriksaan2} yang telah diserahkan melalui ${data.kaedahSerahanLaporan} pada ${data.tarikhSerahanLaporan2}. Senarai lengkap kecacatan juga terkandung dalam Laporan Pemeriksaan Kecacatan Pertama yang telah dihantar pada ${data.tarikhSerahanLaporan}.`;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_CHEN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_CHEN.pdf");
