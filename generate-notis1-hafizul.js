...
const data = {
  ...
  namaPembeli1: "WAN SITI NOOR BINTI WAN HASSAN",
  noKP1: "940618-03-6348",
  namaPembeli2: "MUHAMMAD HAFIZUL HAZWAN BIN MOHD ZAIN",
  noKP2: "940307-01-5451",
  alamatPengirim: [
    "No. 2-19, Jalan Sierra Perdana 5/3,",
    "Taman Sierra Perdana,",
    "81750 Masai,",
    "Johor.",
  ],
  telefonPembeli: "011-10307330",
  emailPembeli: "fiezulhazwan@gmail.com",
  ...
  alamatHartanah: "No. 23, Jalan Wau Barat 10, Bandar Layangkasa, 81700 Pasir Gudang, Johor",

  noSPA: "13759-31/eSPA/111224/PTD248749/01",
  tarikhSPA: "11 Disember 2024",
  jenisSPA: "Jadual G",
  klausaPembaikan: "27(1)",
  klausaSerahan: "29(1)",
  tempohDLP: "24",

  tarikhPemeriksaan1: "16 Mac 2026",
  tarikhPemeriksaan2: "3 Julai 2026",
  tarikhSerahanLaporan: "31 Mac 2026",
  ...
  kecacatan: [
    { tag: "223", lokasi: "Water Tank Area — Floor", kecacatan: "Crack on slab surface", status: "Belum Dibaiki" },
    { tag: "205", lokasi: "Flat Roof — Floor", kecacatan: "Water stagnant on floor slab", status: "Belum Dibaiki" },
  ...
  kronologi: [
    { tarikh: "11 Disember 2024", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual G" },
    { tarikh: "16 Mac 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "31 Mac 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui serahan tangan (hardcopy)" },
    { tarikh: "30 April 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — tiada tindakan pembaikan yang memuaskan" },
...
doc.setFontSize(SZ.BODY);
bk();
doc.text(data.namaPembeli1, mL, y);
y += LH;
...
doc.text(`No. K/P: ${data.noKP1} / ${data.noKP2}`, mL, y); y += LH_S;
doc.text(`E-mel: ${data.emailPembeli}`, mL, y); y += LH_S;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_HAFIZUL.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_HAFIZUL.pdf");
