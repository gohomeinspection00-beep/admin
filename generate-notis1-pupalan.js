...
const data = {
  ...
  emailPembeli: "pupalanpukay@gmail.com",
  ...
  namaProyek: "Bandar Layangkasa, Phase 5",

  noSPA: "13759-31/eSPA/270924/PTD248797/01",
  ...
  tarikhPemeriksaan1: "13 April 2026",
  ...
  kecacatan: [
    { tag: "20", lokasi: "Carporch — Ceiling", kecacatan: "Kebocoran pada permukaan siling (Leaking on ceiling surface)", status: "Belum Dibaiki" },
    { tag: "207", lokasi: "AC Ledge — Floor", kecacatan: "Hollowness pada papak lantai (Hollowness on floor slab)", status: "Belum Dibaiki" },
    { tag: "216", lokasi: "RC Flat Roof — Floor", kecacatan: "Air bertakung pada papak (Stagnant water on slab)", status: "Belum Dibaiki" },
    { tag: "217", lokasi: "RC Flat Roof — Floor", kecacatan: "Hollowness pada papak lantai (Hollowness on floor slab)", status: "Belum Dibaiki" },
    { tag: "219", lokasi: "RC Flat Roof — Floor", kecacatan: "Lubang, keretakan dan mengelupas pada papak lantai (Holes, crack and peel off on floor slab)", status: "Belum Dibaiki" },
    { tag: "223", lokasi: "Top Roof — Roof", kecacatan: "Keretakan/kerosakan pada genting bumbung (Crack/damaged on roof tiles)", status: "Belum Dibaiki" },
  ],
...
numPara(2,
  `Namun, sehingga tarikh notis ini dikeluarkan, didapati bahawa pembaikan terhadap kecacatan yang telah dilaporkan masih belum dilaksanakan sepenuhnya oleh pihak tuan. Malah, melalui susulan (follow-up) yang dibuat oleh saya kepada wakil pemaju melalui WhatsApp pada 2 Julai 2026, pihak wakil pemaju sendiri telah mengesahkan bahawa kecacatan masih belum dibaiki. Antara kecacatan yang masih wujud dan belum dibaiki adalah seperti berikut:`
);
y += 5;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_PUPALAN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_PUPALAN.pdf");
