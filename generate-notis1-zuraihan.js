...
const data = {
  noRujukan: "NOTIS-1/2026/033",

  namaPembeli: "NOOR ZURAIHAN BINTI NGADIRAN",
  alamatPengirim: [
    "No. 18, Jalan Dahlia,",
    "Felda Tenggaroh 5,",
    "86810 Mersing,",
  ...
  noKP: "851109-01-5958",
  telefonPembeli: "017-762 9383",
  emailPembeli: "handsomelady38@gmail.com",
  ...
  alamatHartanah: "No. 68, Jalan Punggai 1, Taman YPJ Punggai, 81600 Pengerang, Johor",
  jenisHartanah: "Rumah Teres 2 Tingkat (PPAM), PTD 14213 (Lot 15561)",
  namaProyek: "PPAM Taman YPJ Punggai Pengerang, Mukim Pantai Timur",

  tarikhSPA: "6 Januari 2022",
  jenisSPA: "Jadual I",
  tempohDLP: "24",

  tarikhPemeriksaan1: "23 Disember 2025",
  tarikhSerahanLaporan: "21 Januari 2026",
  tarikhTamat30Hari: "20 Februari 2026",
  tarikhReInspection: "13 Ogos 2026",
  ...
  kecacatan: [
    { tag: "4", lokasi: "Car Porch — Floor", kecacatan: "Papak lantai tidak rata — ada gap (Floor slab not even, have gap — still observed)", status: "Belum Diselesaikan" },
    { tag: "19", lokasi: "Car Porch — Wall", kecacatan: "Bunyi hollow pada dinding bercat masih ada (Hollow sound on painted wall still observed)", status: "Belum Diselesaikan" },
    { tag: "21", lokasi: "Car Porch — Ceiling", kecacatan: "Keretakan pada konkrit siling / soffit masih ada (Crack on ceiling concrete / soffit still observed)", status: "Belum Diselesaikan" },
    { tag: "22", lokasi: "Car Porch — Ceiling", kecacatan: "Kebocoran pada permukaan siling masih ada — PU injection telah dibuat tetapi tidak disiapkan dan kerja kemasan belum selesai (Leaking on ceiling still observed; PU injection done but not completed, finishing work unfinished)", status: "Belum Diselesaikan" },
    { tag: "313", lokasi: "Water Tank Area — Roof Flashing", kecacatan: "Celahan antara fascia board masih ada (Still have gap between fascial board — Jointing issue)", status: "Belum Diselesaikan" },
    { tag: "315", lokasi: "R.C. Flat Roof — Floor", kecacatan: "Tanda air bertakung pada papak masih ada (Still have water stagnant on slab surface)", status: "Belum Diselesaikan" },
    { tag: "318", lokasi: "R.C. Flat Roof — Floor", kecacatan: "Lapisan kalis air tidak menutup papak dengan sempurna/sepenuhnya (Waterproofing layer not properly/fully cover on the slab — Installation issue)", status: "Belum Diselesaikan" },
    { tag: "328", lokasi: "Findings — Ceiling", kecacatan: "Tiada akses ceiling manhole ke ruang atas siling (Missing access ceiling manhole to above ceiling area)", status: "Belum Diselesaikan" },
  ],

  kronologi: [
    { tarikh: "6 Januari 2022", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual I" },
    { tarikh: "23 Disember 2025", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "21 Januari 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan secara rasmi kepada pemaju" },
    { tarikh: "20 Februari 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum disempurnakan" },
    { tarikh: "13 Ogos 2026", peristiwa: "Pemeriksaan Semula (Re-Inspection) dijalankan — kecacatan masih belum diselesaikan; senarai terkini disertakan bersama notis ini" },
...
numPara(2,
  `Namun, walaupun tempoh tiga puluh (30) hari tersebut telah lama tamat pada ${data.tarikhTamat30Hari}, Pemeriksaan Semula (Re-Inspection) yang dijalankan pada ${data.tarikhReInspection} mendapati masih terdapat kecacatan yang belum diselesaikan oleh pihak tuan. Antara kecacatan yang masih wujud dan belum diselesaikan adalah seperti berikut:`
);
y += 5;
...
numPara(3,
  `Perhatian khusus diberikan kepada dua perkara: (a) bagi item No. 22, pihak tuan telah memulakan kerja pembaikan (PU injection) tetapi meninggalkannya tanpa disiapkan, dan kerja kemasan masih belum selesai — kebocoran pada siling masih berlaku; dan (b) bagi item No. 328, tiada akses ceiling manhole ke ruang atas siling disediakan pada hartanah tersebut. Sehubungan itu, saya menuntut penjelasan rasmi secara bertulis daripada pihak tuan mengenai perkara ini serta penyediaan akses manhole yang sewajarnya.`
);
y += 4;

numPara(4,
  `Di bawah Perjanjian Jual Beli (${data.jenisSPA}) dan Akta Pemajuan Perumahan (Kawalan dan Pelesenan) 1966 (Akta 118), pemaju hendaklah, atas kos dan belanjanya sendiri, membaiki dan memperbetulkan apa-apa kecacatan, pengecutan atau kerosakan lain yang menjejaskan hartanah tersebut dalam Tempoh Liabiliti Kecacatan (DLP — Defect Liability Period) selama ${data.tempohDLP} bulan dari tarikh penyerahan milikan kosong, dalam masa tiga puluh (30) hari selepas menerima notis bertulis daripada pembeli.`
);
y += 4;
...
numPara(7,
  `Merujuk kepada klausa Service of Documents di dalam Perjanjian Jual Beli, sebarang dokumen yang dihantar kepada pihak tuan melalui serahan tangan atau pos berdaftar adalah dianggap sah dan diterima pakai sebagai dokumen rasmi.`
);
y += 4;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_ZURAIHAN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_ZURAIHAN.pdf");
