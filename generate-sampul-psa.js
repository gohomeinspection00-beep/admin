...
const sets = [
  {
    label: "PUPALAN (NOTIS 2) — ke PARKLAND CITY, HQ Melaka  [Ruj: NOTIS-2/2026/016]",
    pengirim: ["PUPALAN A/L WAI RAWAN", "No. 72, Jalan Ketapang 5,", "Taman Rinting,", "81750 Masai, Johor.", "Tel: 012-243 5795"],
  ...
  {
    label: "MOHD SUKRI (NOTIS 2) — ke UDA LAND (SOUTH), Johor Bahru  [Ruj: NOTIS-2/2026/022]",
  ...
  {
    label: "MOHD SUKRI (NOTIS 2) — ke UDA LAND (SOUTH), HQ Kuala Lumpur  [Ruj: NOTIS-2/2026/022]",
    pengirim: ["MOHD SUKRI BIN MOHAMAD NOOR", "No. 18, Jalan Silat Lincah 19,", "Bandar Selesa Jaya,", "81300 Skudai, Johor Bahru, Johor.", "Tel: 011-1112 5646"],
    penerima: ["UDA LAND (SOUTH) SDN. BHD. (197501001813 / 23298-K)", "Tingkat 15, Blok Menara, Kompleks Pertama,", "Jalan Tuanku Abdul Rahman,", "50100 Kuala Lumpur.", "Tel: +603-2730 8500"],
  },
  {
    label: "AHMAD ARIFFUDDIN (NOTIS 1) — ke PARKLAND CITY, HQ Melaka  [Ruj: NOTIS-1/2026/038]",
...
fs.writeFileSync("/home/user/admin/SAMPUL_PUPALAN_SUKRI_ARIFFUDDIN.pdf", Buffer.from(out));
console.log("PDF generated: SAMPUL_PUPALAN_SUKRI_ARIFFUDDIN.pdf");
