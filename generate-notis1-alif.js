...
const data = {
  ...
  namaPembeli: "MUHAMMAD ALIF AIMAN BIN JAMALUDIN",
  alamatPengirim: [
    "Lot 63059, Jalan Persiaran 1/12,",
    "Kampung Batu Muda,",
    "51100 Kuala Lumpur,",
    "WP Kuala Lumpur.",
  ],
  noKP: "960827-10-5803",
  telefonPembeli: "018-282 3432",
  emailPembeli: "alifaiman.finance@gmail.com",
  ...
  jenisHartanah: "Rumah Teres 2 Tingkat (Lot PTD 217520)",
  namaProyek: "Areca Terrace, Phase 4B",

  noSPA: "8971-18/eSPA/231224/PTD217520/01",
  tarikhSPA: "23 Disember 2024",
  jenisSPA: "Jadual G",
  klausaPembaikan: "27(1)",
  klausaSerahan: "29(1)",
  tempohDLP: "24",

  tarikhPemeriksaan1: "10 Jun 2026",
  tarikhSerahanLaporan: "12 Jun 2026",
  kaedahSerahanLaporan: "aplikasi ProFix",
  tarikhTamat30Hari: "12 Julai 2026",

  tarikhNotis: "18 Ogos 2026",
  tarikhDeadline: "2 September 2026",
  tempohNotis1: "15",
  tempohNotis2: "15",

  kecacatan: [
    { tag: "308", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Sokongan sempurna untuk paip agihan yang disambung ke tangki air tiada (Missing proper support for distribution pipe connected to water tank)", status: "Belum Dibaiki" },
    { tag: "309", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Tiada paip discharge / overflow untuk platform tangki air (No discharge / overflow pipe for water tank platform)", status: "Belum Dibaiki" },
    { tag: "319", lokasi: "RC Flat Roof — Floor", kecacatan: "Tanda air bertakung pada permukaan papak lantai (Sign of stagnant water on floor slab)", status: "Belum Dibaiki" },
    { tag: "330", lokasi: "Top Roof — Roof", kecacatan: "Sisa binaan di atas bumbung (Construction left over)", status: "Belum Dibaiki" },
    { tag: "331", lokasi: "Top Roof — Roof", kecacatan: "Kerosakan pada roof ridge (Damage on roof ridge)", status: "Belum Dibaiki" },
    { tag: "332", lokasi: "Top Roof — Roof", kecacatan: "Kerosakan pada genting bumbung (Damage on roof tiles)", status: "Belum Dibaiki" },
    { tag: "333", lokasi: "Top Roof — Fixtures", kecacatan: "Kemungkinan air bertakung di dalam gutter hadapan dan belakang (Possible water stagnant inside front and rear gutter)", status: "Belum Dibaiki" },
    { tag: "334", lokasi: "Top Roof — Fixtures", kecacatan: "Kesan kotoran pada gutter (Stain on gutter)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "23 Disember 2024", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual G" },
    { tarikh: "10 Jun 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "12 Jun 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui aplikasi ProFix" },
    { tarikh: "12 Julai 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum dilaksanakan" },
    { tarikh: "18 Ogos 2026", peristiwa: "Notis Pertama (First Notice) dikeluarkan" },
    { tarikh: "2 September 2026", peristiwa: "Tarikh akhir pembaikan (15 hari dari Notis Pertama)" },
  ],
...
fs.writeFileSync("/home/user/admin/NOTIS_1_ALIF.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_ALIF.pdf");
