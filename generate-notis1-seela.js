...
const data = {
  noRujukan: "NOTIS-1/2026/008",

  namaPembeli: "SEELA DEVARAJU",
  alamatPengirim: [
    "No. 2, Jalan Palma Buluh 14,",
    "Desa Palma,",
    "81100 Johor Bahru,",
    "Johor.",
  ],
  ...
  noSyarikat: "(457736-W)",
  alamatPenerima: [
    "NASA Land Management Sdn Bhd,",
    "1 Jalan Palma Puteri 4,",
    "Desa Palma,",
    "81100 Johor Bahru, Johor.",
  ],
  emailPemaju: "pmmnc@ijm.com",

  alamatHartanah: "No. 2, Jalan Palma Buluh 14, Desa Palma, 81100 Johor Bahru, Johor",
  jenisHartanah: "Rumah Teres 2 Tingkat - Jenis Corner Lot (A1)",
  namaProyek: "Desa Palma Phase 11A, Johor Bahru",

  noSPA: "10241-6/eSPA/161223/142834-01",
  tarikhSPA: "16 Disember 2023",
  jenisSPA: "Jadual G",
  hargaBelian: "RM1,071,000.00",
...
fs.writeFileSync("/home/user/admin/NOTIS_1_SEELA.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_SEELA.pdf");
