...
const data = {
  ...
  namaProyek: "Bandar Putra Kulai, Phase 2C01A — Marvela 2",
  ...
  tarikhSerahKunci: "10 Jun 2026",
  tarikhPemeriksaan1: "13 Jun 2026",
  ...
  kecacatan: [
    { tag: "18", lokasi: "Car Porch — Ceiling", kecacatan: "RC bar terdedah pada siling manhole (Exposed RC bar on manhole ceiling)", status: "Belum Dibaiki" },
    { tag: "21", lokasi: "Car Porch — Plumbing & Sanitary", kecacatan: "Kelembapan tinggi pada siling manhole — kebocoran (High moisture on manhole ceiling)", status: "Belum Dibaiki" },
    { tag: "76", lokasi: "Kitchen — Plumbing & Sanitary", kecacatan: "Keretakan pada jubin penutup manhole (Cracks on tiles for manhole cover)", status: "Belum Dibaiki" },
    { tag: "100", lokasi: "Bathroom 3 — Ceiling", kecacatan: "Kelembapan tinggi pada manhole siling — kebocoran (High moisture on ceiling manhole)", status: "Belum Dibaiki" },
    { tag: "129", lokasi: "Family Area — Wall", kecacatan: "Hollowness pada dinding bercat (Hollowness on painted wall)", status: "Belum Dibaiki" },
    { tag: "267", lokasi: "Water Tank Area — Fixtures", kecacatan: "Penutup tangki air tidak dapat ditutup dengan sempurna (Water tank cover cannot properly close)", status: "Belum Dibaiki" },
    { tag: "268", lokasi: "Water Tank Area — Fixtures", kecacatan: "Tangki air dalam keadaan kotor dan perlu dibersihkan (Water tank in dirty condition)", status: "Belum Dibaiki" },
    { tag: "269", lokasi: "Water Tank Area — Fixtures", kecacatan: "Kesan air (water mark) pada platform kayu tangki air", status: "Belum Dibaiki" },
    { tag: "271", lokasi: "Top Roof — Ceiling", kecacatan: "Kerosakan pada fascia board menyebabkan bukaan besar (Damage on fascia board causes of large opening)", status: "Belum Dibaiki" },
    { tag: "272", lokasi: "Top Roof — Roof", kecacatan: "Kerosakan dan pemasangan genting bumbung tidak sempurna (Damage and improper installation of roof tiles)", status: "Belum Dibaiki" },
    { tag: "273", lokasi: "Top Roof — Roof", kecacatan: "Keretakan pada genting bumbung (Crack on roof tiles)", status: "Belum Dibaiki" },
  ],
...
fs.writeFileSync("/home/user/admin/NOTIS_1_HAFIZKARTINI.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_HAFIZKARTINI.pdf");
