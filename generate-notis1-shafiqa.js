...
const data = {
  noRujukan: "NOTIS-1/2026/045",

  namaPembeli: "NURSHAFIQA BINTI MD YUNUS",
  alamatPengirim: [
    "No. 31, Jalan Silat Cekak 15,",
    "Bandar Selesa Jaya,",
    "81300 Skudai,",
    "Johor.",
  ],
  noKP: "931207-01-6292",
  telefonPembeli: "017-707 1400",
  emailPembeli: "nurshafiqa.yunus@yahoo.com",

  namaPemaju: "PERMAS JAYA SDN. BHD.",
  noSyarikat: "(197301000637 / 14161-T)",
  alamatPenerima: (process.argv[2] === "PERMASMALL") ? [
    "#G-33, Blk A, Permas Mall,",
  ...
  alamatHartanah: "01-03, Blok B, Apartment Bayu Permas, Jalan Permas 12/21, Bandar Baru Permas Jaya, 81750 Masai, Johor",
  jenisHartanah: "Pangsapuri — Parcel B-01-03, Tingkat 1, Blok B",
  namaProyek: "Apartmen Bayu Permas, Mukim Plentong (PTD 250169)",

  noSPA: "835-12/eSPA/230524/B-01-03/01",
  tarikhSPA: "10 Julai 2024",
  jenisSPA: "Jadual H",
  klausaPembaikan: "30(1)",
  klausaSerahan: "32(1)",
  tempohDLP: "24",

  tarikhPemeriksaan1: "7 Ogos 2026",
  tarikhSerahanLaporan: "10 Ogos 2026",
  kaedahSerahanLaporan: "serahan tangan (hardcopy)",

  tarikhNotis: "17 September 2026",
  tarikhDeadline: "2 Oktober 2026",
  tempohNotis1: "15",
  tempohNotis2: "15",

  kecacatan: [
    { tag: "11", lokasi: "External Area — Wall", kecacatan: "Keretakan pada hampir keseluruhan permukaan dinding luar (Cracks observed on most of the external wall surface)", status: "Belum Dibaiki" },
    { tag: "12", lokasi: "External Area — Wall", kecacatan: "Hollowness pada permukaan dinding bercat (Hollowness detected on the painted wall surface)", status: "Belum Dibaiki" },
    { tag: "49", lokasi: "Balcony — Wall", kecacatan: "Bunyi hollow pada dinding bercat (Hollow sound on painted wall)", status: "Belum Dibaiki" },
    { tag: "50", lokasi: "Balcony — Ceiling", kecacatan: "Permukaan kasar dan cat tidak sekata pada siling (Rough surface and uneven painting on the ceiling)", status: "Belum Dibaiki" },
    { tag: "51", lokasi: "Balcony — Ceiling", kecacatan: "Keretakan dengan hollowness pada soffit (Crack with hollowness on soffit)", status: "Belum Dibaiki" },
    { tag: "69", lokasi: "Master Bedroom — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "70", lokasi: "Master Bedroom — Wall", kecacatan: "Ketidakjajaran ketara pada permukaan dinding (Visible alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "71", lokasi: "Master Bedroom — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "87", lokasi: "Master Bathroom — Floor", kecacatan: "Air bertakung pada jubin lantai (Stagnant water observed on floor tile)", status: "Belum Dibaiki" },
    { tag: "105", lokasi: "Bedroom 2 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue observed on the wall surface)", status: "Belum Dibaiki" },
    { tag: "106", lokasi: "Bedroom 2 — Wall", kecacatan: "Ketidakjajaran ketara pada permukaan dinding (Visible alignment issue observed on the wall surface)", status: "Belum Dibaiki" },
    { tag: "107", lokasi: "Bedroom 2 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue observed on the wall surface)", status: "Belum Dibaiki" },
    { tag: "108", lokasi: "Bedroom 2 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "150", lokasi: "Bedroom 3 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "151", lokasi: "Bedroom 3 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding (Alignment issue on wall surface)", status: "Belum Dibaiki" },
    { tag: "152", lokasi: "Bedroom 3 — Wall", kecacatan: "Ketidakjajaran pada permukaan dinding sekeliling tingkap (Alignment issue on wall surface around window)", status: "Belum Dibaiki" },
    { tag: "159", lokasi: "Bedroom 3 — Wall", kecacatan: "Hollowness pada dinding bercat (Hollowness on painted wall)", status: "Belum Dibaiki" },
    { tag: "167", lokasi: "Bedroom 3 — Timber Floor", kecacatan: "Lantai kayu tenggelam/mendap (Sunken timber flooring)", status: "Belum Dibaiki" },
    { tag: "168", lokasi: "Bedroom 3 — Timber Floor", kecacatan: "Skirting tidak sejajar (Skirting exhibits an alignment issue)", status: "Belum Dibaiki" },
    { tag: "182", lokasi: "Yard — Plumbing & Sanitary", kecacatan: "Kebocoran pada gully trap (Leaking on gully trap)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "10 Julai 2024", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual H" },
    { tarikh: "7 Ogos 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "10 Ogos 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan secara serahan tangan (hardcopy) kepada pihak pemaju" },
    { tarikh: "9 September 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum dilaksanakan" },
    { tarikh: "17 September 2026", peristiwa: "Notis Pertama (First Notice) dikeluarkan" },
    { tarikh: "2 Oktober 2026", peristiwa: "Tarikh akhir pembaikan (15 hari dari Notis Pertama)" },
  ],
...
numPara(2,
  `Namun, sehingga tarikh notis ini dikeluarkan, didapati bahawa pembaikan terhadap kecacatan yang telah dilaporkan masih belum dilaksanakan oleh pihak tuan, walaupun tempoh tiga puluh (30) hari telah tamat pada 9 September 2026. Pemeriksaan kendiri oleh saya mengesahkan kecacatan masih wujud. Antara kecacatan yang masih wujud dan belum dibaiki adalah seperti berikut:`
);
y += 5;
...
numPara(4,
  `Perhatian turut diberikan kepada item No. 182 — kebocoran aktif pada gully trap di ruang Yard yang boleh menyebabkan kerosakan air berterusan; item No. 167 dan No. 168 — lantai kayu (timber flooring) yang tenggelam/mendap serta skirting yang tidak sejajar di Bedroom 3, yang memerlukan pembaikan pada asas lantai dan bukan sekadar penggantian permukaan; serta item No. 11 — keretakan pada hampir keseluruhan permukaan dinding luar bangunan. Pihak tuan dituntut mengesan dan membaiki PUNCA setiap kecacatan ini dengan sempurna.`
);
y += 4;
...
const outName = (process.argv[2] === "PERMASMALL") ? "NOTIS_1_SHAFIQA_PERMASMALL.pdf" : "NOTIS_1_SHAFIQA.pdf";
