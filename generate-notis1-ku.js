...
const data = {
  noRujukan: "NOTIS-1/2026/013",

  namaPembeli: "KU HUI WEN",
  alamatPengirim: [
    "No. 40, Jalan Denai Alam 3/4,",
    "Bandar Layangkasa,",
    "81700 Pasir Gudang,",
    "Johor.",
  ],
  ...
  alamatHartanah: "No. 40, Jalan Denai Alam 3/4, Bandar Layangkasa, 81700 Pasir Gudang, Johor",
  jenisHartanah: "",
  namaProyek: "",
  ...
  tarikhPemeriksaan1: "31 Disember 2025",
  ...
  kecacatan: [
    { tag: "60", lokasi: "Utility", kecacatan: "Crack on floor slab", status: "Belum Dibaiki" },
    { tag: "84", lokasi: "Staircase (M&E)", kecacatan: "Wall light point has low voltage (Live+Earth and Live+Neutral 173.3V)", status: "Belum Dibaiki" },
    { tag: "114", lokasi: "Master Bathroom", kecacatan: "Excessive moisture on wall", status: "Belum Dibaiki" },
    { tag: "145", lokasi: "Bathroom 2", kecacatan: "Hollowness on painted wall", status: "Belum Dibaiki" },
    { tag: "189", lokasi: "Water Tank Area", kecacatan: "Cracks on floor slab (all floor area)", status: "Belum Dibaiki" },
    { tag: "193", lokasi: "Top Roof", kecacatan: "Corroded screws on roof (metal deck and flashing screw)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "31 Disember 2025", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
...
const perkara2 = `Hartanah: ${data.alamatHartanah}`;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_KU.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_KU.pdf");
