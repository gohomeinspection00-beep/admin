...
const data = {
  ...
  namaProyek: "UDA Heights (1C), Bandar Uda Utama",

  noSPA: "8971-17/eSPA/161024/PTD217654/01",
  ...
  tarikhPemeriksaan1: "21 April 2026",
  tarikhSerahanLaporan: "28 April 2026",
  kaedahSerahanLaporan: "aplikasi pemaju (Defect Submissions)",
  tarikhTamat30Hari: "28 Mei 2026",
  tarikhReInspection: "27 Julai 2026",
  tarikhSerahanLaporan2: "28 dan 29 Julai 2026",

  tarikhNotis: "12 Ogos 2026",
  tarikhDeadline: "27 Ogos 2026",
  tempohNotis1: "15",
  tempohNotis2: "15",

  kecacatan: [
    { tag: "7", lokasi: "Bathroom 2 — Pintu (Door)", kecacatan: "Arah bukaan pintu bi-fold tidak mengikut Pelan Lantai (Floor Plan) yang diluluskan — S&P Review (Sliding direction not as per Floor Plan)", status: "Belum Diselesaikan" },
    { tag: "8", lokasi: "Bathroom 3 — Pintu (Door)", kecacatan: "Arah bukaan pintu bi-fold tidak mengikut Pelan Lantai (Floor Plan) yang diluluskan — S&P Review (Sliding direction not as per Floor Plan)", status: "Belum Diselesaikan" },
    { tag: "13", lokasi: "Terrace 1 — Plumbing & Sanitary", kecacatan: "Tanah merah keluar semasa flushing; tanah merah pada paip di dalam manhole menyebabkan air bertakung (Red soil discharged when flushing; red soil in manhole pipe causing water stagnant)", status: "Belum Dibaiki" },
    { tag: "328", lokasi: "Water Tank Area — Floor", kecacatan: "Air bertakung masih ada pada permukaan lantai (Water stagnant still present)", status: "Belum Dibaiki" },
    { tag: "331", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Kulat di dalam paip serta pertumbuhan tumbuhan liar (Fungus in pipe and wild plant growth)", status: "Belum Dibaiki" },
    { tag: "339", lokasi: "AC Ledge 2 (Terrace 3) — Floor", kecacatan: "Keretakan pada keseluruhan permukaan papak (Crack on whole slab surface)", status: "Belum Dibaiki" },
    { tag: "340", lokasi: "AC Ledge 2 — Floor", kecacatan: "Kerosakan pada papak (Damage on slab)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "16 Oktober 2024", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual G" },
    { tarikh: "31 Januari 2026", peristiwa: "Penyerahan Milikan Kosong (Vacant Possession) — Tempoh Liabiliti Kecacatan (DLP) bermula" },
    { tarikh: "21 April 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "28 April 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui aplikasi pemaju — Batch 1 (342 kecacatan)" },
    { tarikh: "28 Mei 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum disempurnakan" },
    { tarikh: "27 Julai 2026", peristiwa: "Pemeriksaan Semula (Re-Inspection) dijalankan — kecacatan masih belum diselesaikan sepenuhnya" },
    { tarikh: "28 & 29 Julai 2026", peristiwa: "Laporan Re-Inspection diserahkan kepada pemaju melalui aplikasi pemaju — Batch 2 (159 kecacatan) dan Batch 3 (114 kecacatan)" },
    { tarikh: "12 Ogos 2026", peristiwa: "Notis Pertama (First Notice) dikeluarkan" },
    { tarikh: "27 Ogos 2026", peristiwa: "Tarikh akhir pembaikan (15 hari dari Notis Pertama)" },
  ],

  salinanKepada: [
    {
      nama: "UDA LAND (SOUTH) SDN. BHD. — Pejabat Johor Bahru",
      alamat: ["Wisma Sbbu, No. 1, Jalan Padi Mahsuri 12,", "Bandar Baru Uda,", "81200 Johor Bahru, Johor."],
    },
  ],
};
...
para(
  `Saya, ${data.namaPembeli} (No. K/P: ${data.noKP}), pemilik unit hartanah di alamat di atas, sebagaimana termaktub di dalam Perjanjian Jual Beli bertarikh ${data.tarikhSPA} (No. Rujukan SPA: ${data.noSPA}) mengikut ${data.jenisSPA}, telah menjalankan Pemeriksaan Kecacatan (Defect Inspection) pada ${data.tarikhPemeriksaan1} dan telah mengemukakan Laporan Pemeriksaan Kecacatan (Defect Inspection Report) secara rasmi kepada pihak tuan melalui ${data.kaedahSerahanLaporan} pada ${data.tarikhSerahanLaporan}, merangkumi sebanyak 342 kecacatan (Batch 1). Pihak tuan telah diberikan tempoh tiga puluh (30) hari untuk melaksanakan pembaikan terhadap semua kecacatan yang dilaporkan.`
);
y += 4;

numPara(2,
  `Namun, walaupun tempoh tiga puluh (30) hari tersebut telah tamat pada ${data.tarikhTamat30Hari}, Pemeriksaan Semula (Re-Inspection) yang dijalankan pada ${data.tarikhReInspection} mendapati masih terdapat banyak kecacatan yang belum diselesaikan oleh pihak tuan. Laporan Re-Inspection tersebut telah diserahkan kepada pihak tuan melalui aplikasi pemaju pada ${data.tarikhSerahanLaporan2}, iaitu Batch 2 (159 kecacatan) dan Batch 3 (114 kecacatan). Antara kecacatan yang masih wujud dan belum diselesaikan adalah seperti berikut:`
);
y += 5;
...
numPara(3,
  `Perhatian khusus diberikan kepada item No. 7 dan No. 8 (S&P Review) di mana arah bukaan pintu bi-fold di Bathroom 2 dan Bathroom 3 didapati tidak mengikut Pelan Lantai (Floor Plan) yang diluluskan di dalam Perjanjian Jual Beli. Sehubungan itu, saya menuntut maklum balas rasmi secara bertulis daripada pihak tuan berserta dokumentasi yang sewajarnya (proper documentation), termasuk pelan pindaan yang diluluskan oleh Pihak Berkuasa (jika ada), bagi menjelaskan percanggahan tersebut kepada saya selaku pembeli.`
);
y += 4;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_ARIDHASAN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_ARIDHASAN.pdf");
