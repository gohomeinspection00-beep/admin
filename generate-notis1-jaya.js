...
const data = {
  noRujukan: "NOTIS-1/2026/014",

  namaPembeli: "JAYA CHANDRAN A/L NALESAMY",
  alamatPengirim: [
    "No 13438, Jalan Rajawali 9,",
    "Bandar Putra,",
    "81000 Kulai,",
    "Johor.",
  ],
  noKP: "781128-01-5063",
  telefonPembeli: "016-722 9052",
  emailPembeli: "jcnalesamy@gmail.com",
  ...
  jenisHartanah: "Rumah Teres 1 Tingkat (End Lot, 1984 sq.ft.)",
  namaProyek: "Bandar Putra Kulai, Phase 1B01 Piccolo 3",

  noSPA: "7147-83/eSPA/190724/PTD110150/01",
  tarikhSPA: "19 Julai 2024",
  jenisSPA: "Jadual G",
  ...
  kecacatan: [
    { tag: "94", lokasi: "Master Bathroom", kecacatan: "Hollowness on painted wall", status: "Pembaikan Tidak Sempurna" },
    { tag: "170", lokasi: "Metal Deck Area (Car Porch)", kecacatan: "Stagnant water and have mold on slab", status: "Belum Dibaiki" },
    { tag: "193", lokasi: "Water Tank Area", kecacatan: "Stagnant water on floor slab", status: "Belum Dibaiki" },
    { tag: "194", lokasi: "Water Tank Area", kecacatan: "Mold on floor slab", status: "Belum Dibaiki" },
    { tag: "199", lokasi: "Water Tank Area", kecacatan: "Improper installation of roof flashing", status: "Belum Dibaiki" },
    { tag: "201", lokasi: "Water Tank Area", kecacatan: "Water tank should be clean", status: "Belum Dibaiki" },
  ],
...
fs.writeFileSync("/home/user/admin/NOTIS_1_JAYA.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_JAYA.pdf");
