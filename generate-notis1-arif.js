...
const data = {
  ...
  namaPembeli: "MUHAMMAD ARIF BIN AHMED",
  alamatPengirim: [
  ...
  noKP: "900622-01-5375",
  telefonPembeli: "013-654 3211",
  emailPembeli: "arifray90@gmail.com",
  ...
  alamatHartanah: "No. 439, Jalan Kedidi 14, Bandar Putra, 81000 Kulai, Johor",
  jenisHartanah: "Rumah Teres 2 Tingkat (2039 sq.ft.)",
  namaProyek: "Bandar Putra Kulai (2C01B Marvela 3), Phase 2",

  noSPA: "7147-85/eSPA/040725/PTD113774/01",
  tarikhSPA: "4 Julai 2025",
  jenisSPA: "Jadual G",
  ...
  tarikhSerahanLaporan: "29 Mei 2026 dan 3 Jun 2026",
  ...
  kecacatan: [
    { tag: "23", lokasi: "Carporch — Ceiling", kecacatan: "Kebocoran — Kelembapan tinggi pada papak lantai dalam manhole siling (Leaking issues)", status: "Belum Dibaiki" },
    { tag: "27", lokasi: "Carporch — Imprint Floor", kecacatan: "Air bertakung pada papak lantai imprint (Stagnant water on floor slab)", status: "Belum Dibaiki" },
    { tag: "36", lokasi: "Carporch — Imprint Floor", kecacatan: "Keretakan pada jubin lantai imprint (Crack on imprint floor tile)", status: "Belum Dibaiki" },
    { tag: "37", lokasi: "Carporch — Imprint Floor", kecacatan: "Keretakan pada papak imprint (Crack on imprint slab)", status: "Belum Dibaiki" },
    { tag: "58", lokasi: "Living & Dining — M&E", kecacatan: "Apabila suis dimatikan, titik lampu menunjukkan voltan tinggi 107v (High voltage at light point when switch off)", status: "Belum Dibaiki" },
    { tag: "86", lokasi: "Kitchen — M&E", kecacatan: "Apabila suis dimatikan, voltan pada titik lampu menunjukkan bacaan tinggi (High voltage at light point when switch off)", status: "Belum Dibaiki" },
    { tag: "98", lokasi: "Bedroom 4 — M&E", kecacatan: "Apabila suis dimatikan, voltan menunjukkan bacaan tinggi (High voltage when switch off)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "4 Julai 2025", peristiwa: "Perjanjian Jual Beli (SPA) ditandatangani — Jadual G" },
...
fs.writeFileSync("/home/user/admin/NOTIS_1_ARIF.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_ARIF.pdf");
