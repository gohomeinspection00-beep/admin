...
const data = {
  noRujukan: "NOTIS-1/2026/029",

  namaPembeli: "NORFATHIN BINTI RAMLI",
  alamatPengirim: [
    "No. 43-C, Kampung Pemuda Jaya,",
    "Seelong,",
    "81400 Senai,",
    "Johor.",
  ],
  noKP: "901117-01-5408",
  telefonPembeli: "017-764 4187",
  emailPembeli: "fathinramli1@gmail.com",
  ...
  alamatHartanah: "No. 414, Jalan Kedidi 13, Bandar Putra, 81000 Kulai, Johor",
  jenisHartanah: "Rumah Teres 2 Tingkat (Type A, 1,400 kaki persegi, Lot PTD 113809)",
  namaProyek: "Marvela 3, Fasa 2G01B, Bandar Putra Kulai",

  noSPA: "7147-85/eSPA/170125/PTD113809/01",
  jenisSPA: "Jadual G",
  klausaPembaikan: "27(1)",
  klausaSerahan: "29(1)",
  tempohDLP: "24",

  tarikhPemeriksaan1: "5 Julai 2026",
  tarikhSerahanLaporan: "9 Julai 2026",
  kaedahSerahanLaporan: "Aplikasi IOI Support",
  tarikhTamat30Hari: "8 Ogos 2026",

  tarikhNotis: "24 Ogos 2026",
  tarikhDeadline: "8 September 2026",
  tempohNotis1: "15",
  tempohNotis2: "15",

  kecacatan: [
    { tag: "201", lokasi: "Water Tank Area — Fixtures", kecacatan: "Air di dalam tangki dalam keadaan kotor dan perlu dibersihkan (Water in dirty condition — need to be cleaned)", status: "Belum Dibaiki" },
    { tag: "202", lokasi: "Water Tank Area — Fixtures", kecacatan: "Penutup tangki air tidak dapat ditutup dengan sempurna (Water tank cover cannot properly close)", status: "Belum Dibaiki" },
    { tag: "204", lokasi: "RC Flat Roof — Floor", kecacatan: "Air bertakung pada permukaan lantai (Water stagnant on floor)", status: "Belum Dibaiki" },
    { tag: "219", lokasi: "Flat Roof (Left Side) — Wall", kecacatan: "Keretakan dan kerosakan pada dinding serta bahagian atas dinding — keseluruhan (Crack and damaged on wall and on top of the wall — All)", status: "Belum Dibaiki" },
    { tag: "221", lokasi: "Top Roof — Roof", kecacatan: "Genting bumbung rosak dan retak (Damaged and crack on roof tiles — Major defects)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "5 Julai 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "9 Julai 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui Aplikasi IOI Support — No. Kes: C94780, C94803 & C94805" },
    { tarikh: "8 Ogos 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum dilaksanakan" },
    { tarikh: "24 Ogos 2026", peristiwa: "Notis Pertama (First Notice) dikeluarkan" },
    { tarikh: "8 September 2026", peristiwa: "Tarikh akhir pembaikan (15 hari dari Notis Pertama)" },
  ],
...
const fn = `*Senarai di atas bukanlah senarai penuh. Kecacatan lain yang turut belum diselesaikan adalah sebagaimana terkandung dalam Laporan Pemeriksaan Kecacatan yang telah diserahkan kepada pihak tuan melalui ${data.kaedahSerahanLaporan} pada ${data.tarikhSerahanLaporan} (No. Kes: C94780, C94803 & C94805).`;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_NORFATHIN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_NORFATHIN.pdf");
