...
const data = {
  noRujukan: "NOTIS-1/2026/009",

  namaPembeli: "MOHAMMAD NAJIP BIN BADRI",
  alamatPengirim: [
    "No. 402-23, Lorong Hj. Md. Sin,",
    "Parit Kudus,",
    "82000 Pontian,",
    "Johor.",
  ],
  noKP: "940312-01-5157",
  telefonPembeli: "011-16106559",
  emailPembeli: "mohdnajip08@gmail.com",

  namaPemaju: "SCIENTEX QUATARI SDN. BHD.",
  noSyarikat: "(28008-M)",
  alamatPenerima: [
    "Scientex Pulai Sales Gallery,",
    "Persiaran Pulai Mutiara,",
    "Taman Pulai Mutiara,",
    "81300 Johor Bahru, Johor.",
  ],

  alamatHartanah: "No. 7, Jalan Pulai Duta 2/3, Taman Pulai Duta, 81300 Johor Bahru, Johor",

  noSPA: "9294-62/eSPA/290224/PTD224539/01",
  tarikhSPA: "29 Februari 2024",
  jenisSPA: "Jadual G",
  ...
  kecacatan: [
    { tag: "273", lokasi: "Top Roof", kecacatan: "Possible water stagnant on gutter", status: "Belum Dibaiki" },
    { tag: "233", lokasi: "Bathroom 2", kecacatan: "Construction leftover inside floor trap", status: "Belum Dibaiki" },
  ...
  kronologi: [
    ...
    { tarikh: "8 Julai 2026", peristiwa: "Laporan Pemeriksaan Kecacatan Kali Kedua diserahkan kepada pemaju secara serahan tangan. Pemilik turut cuba menyerahkan Notis Pertama pada masa yang sama, namun pihak pemaju enggan mengecop akuan terima notis tersebut — pihak pemaju hanya mengecop akuan terima bagi laporan sahaja" },
    { tarikh: "17 Julai 2026", peristiwa: "Notis Pertama (First Notice) dikeluarkan semula secara rasmi" },
...
fs.writeFileSync("/home/user/admin/NOTIS_1_NAJIP.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_NAJIP.pdf");
