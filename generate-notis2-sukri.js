...
const VERSI = process.argv[2] || "JB";

const ALAMAT = {
  JB: ["No. 1, Jalan Padi Mahsuri 12,", "Bandar Baru Uda,", "81200 Johor Bahru, Johor."],
  KL: ["Tingkat 15, Blok Menara,", "Kompleks Pertama,", "Jalan Tuanku Abdul Rahman,", "50100 Kuala Lumpur."],
};

const data = {
  noRujukanNotis2: "NOTIS-2/2026/022",
  noRujukanNotis1: "NOTIS-1/2026/022",
  ...
  noRujukanSPA: "8971-18/eSPA/231224/PTD217417/01",
...
const outName = VERSI === "KL" ? "NOTIS_2_SUKRI_KL.pdf" : "NOTIS_2_SUKRI_JB.pdf";
