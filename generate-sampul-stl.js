...
const sets = [
  {
    label: "1. SEELA DEVARAJU — ke NASA LAND, Desa Palma JB  [Ruj: NOTIS-1/2026/008]",
    pengirim: ["SEELA DEVARAJU", "No. 2, Jalan Palma Buluh 14,", "Desa Palma,", "81100 Johor Bahru, Johor.", "Tel: 012-766 9002"],
    penerima: ["NASA LAND SDN. BHD. (457736-W)", "NASA Land Management Sdn Bhd,", "1, Jalan Palma Puteri 4,", "Desa Palma,", "81100 Johor Bahru, Johor."],
  },
  {
    label: "2. TEO GEOK YAN — ke COUNTRY VIEW RESOURCES, Menara Landmark JB  [Ruj: NOTIS-1/2026/035]",
  ...
  {
    label: "3. TEO GEOK YAN — salinan (CC) ke peguam stakeholder K.H. KOH, AZHAR & KOH  [Ruj: NOTIS-1/2026/035]",
    pengirim: ["TEO GEOK YAN", "A-162, Aurora Resort,", "Jalan Aurora Utama, Aurora Sentral,", "79100 Iskandar Puteri, Johor.", "Tel: +65 8617 8812"],
...
fs.writeFileSync("/home/user/admin/SAMPUL_SEELA_TEO_LOO.pdf", Buffer.from(out));
console.log("PDF generated: SAMPUL_SEELA_TEO_LOO.pdf");
