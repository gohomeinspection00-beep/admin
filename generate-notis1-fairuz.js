...
numPara(3,
  `Namun, sehingga tarikh notis ini dikeluarkan, tiada sebarang kerja pembaikan dimulakan atau dimaklumkan kepada saya oleh pihak tuan. Antara kecacatan yang dilaporkan dan masih belum dibaiki adalah seperti berikut:`
);
y += 5;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_FAIRUZ.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_FAIRUZ.pdf");
