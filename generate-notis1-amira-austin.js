...
const data = {
  ...
  alamatPenerima: [
    "(Sales Gallery)",
    "No. 17 - 21, Block A, Austin V Square,",
    "Jalan Austin Perdana 2, Taman Austin Perdana,",
    "81100 Johor Bahru, Johor.",
    "Tel: 07-355 4888 / 019-422 2624",
  ],
  ...
  salinanKepada: [
    { nama: "Mah Sing / Meridin East", alamat: ["melalui e-mel: crn@mahsing.com.my", "dan cspm.me@mahsing.com.my"] },
  ],
};
...
fs.writeFileSync("/home/user/admin/NOTIS_1_AMIRA_AUSTIN.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_AMIRA_AUSTIN.pdf");
