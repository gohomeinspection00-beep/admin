...
const data = {
  ...
  alamatHartanah: "No. 97, Areca 4B, Jalan Uda Utama 5/4, 81200 Johor Bahru, Johor",
  ...
  kecacatan: [
    { tag: "5", lokasi: "Car Porch — Floor", kecacatan: "Keretakan dan kerosakan pada papak lantai (Cracks and damaged on floor slab)", status: "Belum Dibaiki" },
    { tag: "58", lokasi: "Kitchen — M&E", kecacatan: "Open grounding pada soket (Open grounding defect on socket — isu keselamatan elektrik)", status: "Belum Dibaiki" },
    { tag: "59", lokasi: "Kitchen — M&E", kecacatan: "Voltan rendah Live + Earth pada light point — 154V (Live + Earth for light point has low voltage)", status: "Belum Dibaiki" },
    { tag: "236", lokasi: "Ceiling Area (Master Bedroom) — Roof", kecacatan: "Kerosakan pada insulation sheet (Damaged on insulation sheet — Major defects)", status: "Belum Dibaiki" },
    { tag: "244", lokasi: "Ceiling Area (Bedroom 3) — Ceiling", kecacatan: "Sisa binaan (paip PVC) di atas siling (Construction leftover on ceiling)", status: "Belum Dibaiki" },
    { tag: "251", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Tiada paip discharge untuk papak tangki air (Missing discharge pipe for water tank slab — Major defects)", status: "Belum Dibaiki" },
    { tag: "252", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Sokongan sempurna untuk paip agihan yang disambung ke tangki air tiada (Missing proper support for distribution pipe)", status: "Belum Dibaiki" },
    { tag: "259", lokasi: "AC Ledge (Top Roof) — Floor", kecacatan: "Tanda air bertakung pada papak lantai (Sign of stagnant water on floor slab)", status: "Belum Dibaiki" },
    { tag: "261", lokasi: "RC Flat Roof — Floor", kecacatan: "Tanda air bertakung pada papak lantai (Sign of water stagnant on floor slab)", status: "Belum Dibaiki" },
    { tag: "272", lokasi: "Top Roof — Roof", kecacatan: "Tanda air bertakung di dalam roof gutter (Sign of stagnant water inside roof gutter)", status: "Belum Dibaiki" },
    { tag: "274", lokasi: "Top Roof — Roof", kecacatan: "Chipping pada genting bumbung (Chipping on roof tiles)", status: "Belum Dibaiki" },
  ],

  kronologi: [
    { tarikh: "15 Julai 2026", peristiwa: "Pemeriksaan Kecacatan Kali Pertama (First Defect Inspection) dijalankan ke atas hartanah" },
    { tarikh: "20 Julai 2026", peristiwa: "Laporan Pemeriksaan Kecacatan diserahkan kepada pemaju melalui aplikasi ProFix — 248 defect items" },
    { tarikh: "17 Ogos 2026", peristiwa: "E-mel makluman \"Tiada Progress dari Kontraktor\" dihantar kepada pemaju dan pasukan projek Areca 4B" },
    { tarikh: "18 Ogos 2026", peristiwa: "UDA Property Customer Care membalas — mengesahkan laporan 248 item diterima dan mengarahkan kontraktor mengemas kini status di ProFix; joint inspection dicadangkan" },
    { tarikh: "19 Ogos 2026", peristiwa: "Tamat tempoh 30 hari pembaikan oleh pemaju — pembaikan masih belum dilaksanakan" },
  ...
  salinanKepada: [
    {
      nama: "UDA LAND (SOUTH) SDN. BHD. — Ibu Pejabat",
...
numPara(2,
  `Namun, sehingga tarikh notis ini dikeluarkan, tiada sebarang kerja pembaikan dilaksanakan oleh pihak tuan walaupun tempoh tiga puluh (30) hari telah tamat pada ${data.tarikhTamat30Hari}. Malah, melalui e-mel makluman bertarikh 17 Ogos 2026, pihak tuan sendiri melalui UDA Property Customer Care (e-mel balasan 18 Ogos 2026) telah mengesahkan bahawa laporan 248 kecacatan telah diterima pada ${data.tarikhSerahanLaporan} dan tiada sebarang kemajuan daripada pihak kontraktor, sehingga pihak tuan sendiri mengarahkan kontraktor mengemas kini status di aplikasi ProFix dan mencadangkan pemeriksaan bersama (joint inspection). Antara kecacatan yang masih wujud dan belum dibaiki adalah seperti berikut:`
);
y += 5;
...
const fn = `*Senarai di atas bukanlah senarai penuh. Kecacatan lain yang turut belum diselesaikan adalah sebagaimana terkandung dalam Laporan Pemeriksaan Kecacatan (248 item) yang telah diserahkan kepada pihak tuan melalui ${data.kaedahSerahanLaporan} pada ${data.tarikhSerahanLaporan}.`;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_NAIM.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_NAIM.pdf");
