...
const D = {
  ...
  penerima: ["MERLIMAU LAND SDN. BHD. (201401015597 / 1091684-M)", "(Alamat Berdaftar)", "No. 48, Jalan Kota Laksamana 2/15,", "Taman Kota Laksamana, Seksyen 2,", "75200 Melaka."],
...
function akuan(label) {
  return [
    ...
    p([t(`Dengan ini diakui bahawa ${D.pemaju} ${D.noSyarikat} telah menerima Notis Pertama — Tuntutan Pembetulan Kecacatan (Defect Rectification Claim) bertarikh ${D.tarikhNotis} dengan rujukan ${D.ruj} daripada ${D.nama} berhubung hartanah di ${D.hartanah}.`)], { spacing: { after: 500, line: 300 } }),
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      ...D.penerima.slice(1).map(a => p([t(a)], { spacing: { after: 20 } })),
