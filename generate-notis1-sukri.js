...
const data = {
  noRujukan: "NOTIS-1/2026/022",

  namaPembeli: "MOHD SUKRI BIN MOHAMAD NOOR",
  alamatPengirim: [
    "No. 18, Jalan Silat Lincah 19,",
    "Bandar Selesa Jaya,",
    "81300 Skudai,",
    "Johor Bahru, Johor.",
  ],
  noKP: "870603-11-5181",
  telefonPembeli: "011-1112 5646",
  emailPembeli: "syukrieny@gmail.com",
  ...
  alamatHartanah: "No. 50, Jalan Uda Utama 5/5, Bandar Uda Utama, 81200 Johor Bahru, Johor",
  jenisHartanah: "Rumah Teres 2 Tingkat (Lot PTD 217417)",
  namaProyek: "Areca Terrace, Phase 4B",

  noSPA: "8971-18/eSPA/231224/PTD217417/01",
  ...
  tarikhPemeriksaan1: "27 Jun 2026",
  tarikhSerahanLaporan: "1 Julai 2026",
  ...
  kecacatan: [
    { tag: "253", lokasi: "Ceiling Area (Master Bedroom) — M&E", kecacatan: "Penutup junction box hilang (Missing junction box cover)", status: "Belum Dibaiki" },
    { tag: "255", lokasi: "Water Tank Area — Roof", kecacatan: "Kerosakan pada insulation sheets (Damage on insulation sheets)", status: "Belum Dibaiki" },
    { tag: "256", lokasi: "Water Tank Area — Plumbing & Sanitary", kecacatan: "Discharge pipe untuk platform tangki air hilang (Missing discharge pipe for water tank platform)", status: "Belum Dibaiki" },
    { tag: "257", lokasi: "Water Tank Area — Fixtures", kecacatan: "Tangki air dalam keadaan kotor dan perlu dibersihkan (Water tank should be clean)", status: "Belum Dibaiki" },
    { tag: "266", lokasi: "RC Flat Roof — Gutter", kecacatan: "Kesan kotoran pada gutter (Stain on gutter)", status: "Belum Dibaiki" },
    { tag: "268", lokasi: "Top Roof — Roof", kecacatan: "Sisa binaan di atas genting bumbung (Construction left over on roof tiles)", status: "Belum Dibaiki" },
    { tag: "269", lokasi: "Top Roof — Roof", kecacatan: "Chipping pada genting bumbung (Chipping on roof tiles)", status: "Belum Dibaiki" },
    { tag: "270", lokasi: "Top Roof — Roof", kecacatan: "Kerosakan pada roof ridge (Damage on roof ridge)", status: "Belum Dibaiki" },
    { tag: "271", lokasi: "Top Roof — Roof", kecacatan: "Genting bumbung pecah (Broken roof tiles — Major defect)", status: "Belum Dibaiki" },
    { tag: "273", lokasi: "AC Ledge — Floor", kecacatan: "Kemungkinan air bertakung pada permukaan papak (Possible water stagnant on slab surface)", status: "Belum Dibaiki" },
  ],
...
numPara(2,
  `Namun, sehingga tarikh notis ini dikeluarkan, didapati bahawa pembaikan terhadap kecacatan yang telah dilaporkan masih belum dilaksanakan oleh pihak tuan, walaupun tempoh tiga puluh (30) hari telah tamat pada 31 Julai 2026. Antara kecacatan yang masih wujud dan belum dibaiki adalah seperti berikut:`
);
y += 5;
...
fs.writeFileSync("/home/user/admin/NOTIS_1_SUKRI.pdf", Buffer.from(out));
console.log("PDF generated: NOTIS_1_SUKRI.pdf");
