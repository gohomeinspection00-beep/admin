...
const sets = [
  {
    label: "NGU YI KIET (NOTIS 2) — ke PARKLAND CITY, Pejabat Bandar Layangkasa  [Ruj: NOTIS-2/2026/028]",
  ...
  {
    label: "NGU YI KIET (NOTIS 2) — ke PARKLAND CITY, HQ Melaka  [Ruj: NOTIS-2/2026/028]",
    pengirim: ["NGU YI KIET", "No. 30, Jalan Berlian 14,", "Taman Cahaya Masai,", "81750 Pasir Gudang, Johor.", "Tel: 014-916 8526"],
...
fs.writeFileSync("/home/user/admin/SAMPUL_NGU_NOTIS2.pdf", Buffer.from(out));
console.log("PDF generated: SAMPUL_NGU_NOTIS2.pdf");
